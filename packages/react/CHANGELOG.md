...
- Updated dependencies [e8e134c]
  - @monorise/base@4.1.0-dev.3

## 5.0.0-dev.2

### Patch Changes

- Updated dependencies [8c1c228]
  - @monorise/base@4.1.0-dev.2
...
- 7b9cd73: Add `useEntityFeed` hook for graph-aware real-time subscriptions.
...
- Updated dependencies [7b9cd73]
- Updated dependencies [d8220f9]
  - @monorise/base@4.1.0-dev.0
